...
outdir="PperpStudy4/z_between_0.2_and_0.3"
...
#mv *PiPlus_ymin*bin{1,4,7,10,13}.png $outdir/
mv *PiPlus_ymin*bin*.png $outdir/



outdir="PperpStudy4/z_between_0.3_and_1.0"
mkdir -p $outdir; rm -r $outdir; mkdir -p $outdir
