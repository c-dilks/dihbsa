//
// File generated by rootcint at Wed Apr 24 20:35:30 2019
...
void Dihadron::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "PhMag", &PhMag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "PhtMag", &PhtMag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "RMag", &RMag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "RtMag", &RtMag);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "phiR_T_byKt", &phiR_T_byKt);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "phiR_T_byRej", &phiR_T_byRej);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "phiR_Perp", &phiR_Perp);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "phiR_byPh", &phiR_byPh);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "phiR_byPhad[2]", phiR_byPhad);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "phiP1P2", &phiP1P2);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pHad_Perp[2]", pHad_Perp);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pPh_Perp", &pPh_Perp);
      R__insp.InspectMember(pPh_Perp, "pPh_Perp.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pR_T_byKt", &pR_T_byKt);
      R__insp.InspectMember(pR_T_byKt, "pR_T_byKt.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pR_T_byRej", &pR_T_byRej);
      R__insp.InspectMember(pR_T_byRej, "pR_T_byRej.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pR_Perp", &pR_Perp);
      R__insp.InspectMember(pR_Perp, "pR_Perp.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "proj", &proj);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "crossAB", &crossAB);
      R__insp.InspectMember(crossAB, "crossAB.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "crossCD", &crossCD);
      R__insp.InspectMember(crossCD, "crossCD.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "sgn", &sgn);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "numer", &numer);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "denom", &denom);
      TObject::ShowMembers(R__insp);
}
...
static int G__DihBsaDict_630_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) DIS::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_630_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      DIS::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
typedef DIS G__TDIS;
static int G__DihBsaDict_630_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__DihBsaDict_630_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DihBsaDict_631_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Trajectory::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_631_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) Trajectory::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_631_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__DihBsaDict_631_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__DihBsaDict_631_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__DihBsaDict_631_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* Dihadron */
static int G__DihBsaDict_632_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   Dihadron* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
...
static int G__DihBsaDict_632_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DihBsaDict_632_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DihBsaDict_632_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 102, (double) ((Dihadron*) G__getstructoffset())->PlaneAngle(*((TVector3*) G__int(libp->para[0])), *((TVector3*) G__int(libp->para[1]))
, *((TVector3*) G__int(libp->para[2])), *((TVector3*) G__int(libp->para[3]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_632_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TVector3* pobj;
         TVector3 xobj = ((Dihadron*) G__getstructoffset())->Reject(*((TVector3*) G__int(libp->para[0])), *((TVector3*) G__int(libp->para[1])));
...
static int G__DihBsaDict_632_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TVector3* pobj;
         TVector3 xobj = ((Dihadron*) G__getstructoffset())->Project(*((TVector3*) G__int(libp->para[0])), *((TVector3*) G__int(libp->para[1])));
         pobj = new TVector3(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__DihBsaDict_632_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) Dihadron::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_632_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Dihadron::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_632_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) Dihadron::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_632_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      Dihadron::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__DihBsaDict_632_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DihBsaDict_632_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Dihadron::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_632_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) Dihadron::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_632_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Dihadron::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DihBsaDict_632_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__DihBsaDict_632_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__DihBsaDict_632_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__DihBsaDict_632_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarDihadron(void) {
   ...
   G__memvar_setup((void*)((long)(&p->vecHad)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TLorentzVector),-1,-1,1,"vecHad[2]=",0,"hadron momentum");
   G__memvar_setup((void*)((long)(&p->vecPh)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TLorentzVector),-1,-1,1,"vecPh=",0,"dihadron total momentum");
   G__memvar_setup((void*)((long)(&p->vecR)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TLorentzVector),-1,-1,1,"vecR=",0,"dihadron relative momentum");
   G__memvar_setup((void*)((long)(&p->vecMmiss)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TLorentzVector),-1,-1,1,"vecMmiss=",0,"used to compute missing mass");
   G__memvar_setup((void*)((long)(&p->bvecPh)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TLorentzVector),-1,-1,1,"bvecPh=",0,"breit frame's dihadron total momentum");
   G__memvar_setup((void*)((long)(&p->PhMag)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"PhMag=",0,"dihadron total momentum");
   G__memvar_setup((void*)((long)(&p->PhtMag)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"PhtMag=",0,"transverse component of dihadron total momentum");
   G__memvar_setup((void*)((long)(&p->RMag)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"RMag=",0,"dihadron relative momentum");
   G__memvar_setup((void*)((long)(&p->RtMag)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"RtMag=",0,"transverse componet of relative momentum");
   G__memvar_setup((void*)((long)(&p->phiR)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiR=",0,"angle[ reaction_plane, R^q etc. (see below) ]");
   G__memvar_setup((void*)((long)(&p->phiH)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiH=",0,"angle[ reaction_plane, Ph^q ]");
   G__memvar_setup((void*)((long)(&p->z)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"z[2]=",0,"fraction of energy of fragmenting parton");
   G__memvar_setup((void*)((long)(&p->zpair)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"zpair=",0,"fraction of energy of fragmenting parton");
   G__memvar_setup((void*)((long)(&p->Mh)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"Mh=",0,"dihadron invariant mass");
   G__memvar_setup((void*)((long)(&p->Mmiss)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"Mmiss=",0,"missing mass");
   G__memvar_setup((void*)((long)(&p->xF)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"xF=",0,"feynman-x");
   G__memvar_setup((void*)((long)(&p->phiR_T_byKt)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiR_T_byKt=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->phiR_T_byRej)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiR_T_byRej=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->phiR_Perp)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiR_Perp=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->phiR_byPh)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiR_byPh=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->phiR_byPhad)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiR_byPhad[2]=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->phiP1P2)-(long)(p)),102,0,0,-1,G__defined_typename("Float_t"),-1,1,"phiP1P2=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TVector3),-1,-1,4,"pHad_Perp[2]=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TVector3),-1,-1,4,"pPh_Perp=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TVector3),-1,-1,4,"pR_T_byKt=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TVector3),-1,-1,4,"pR_T_byRej=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TVector3),-1,-1,4,"pR_Perp=",0,(char*)NULL);
   G__memvar_setup((void*)0,102,0,0,-1,G__defined_typename("Float_t"),-1,4,"proj=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TVector3),-1,-1,4,"crossAB=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TVector3),-1,-1,4,"crossCD=",0,(char*)NULL);
   G__memvar_setup((void*)0,102,0,0,-1,G__defined_typename("Float_t"),-1,4,"sgn=",0,(char*)NULL);
   G__memvar_setup((void*)0,102,0,0,-1,G__defined_typename("Float_t"),-1,4,"numer=",0,(char*)NULL);
   G__memvar_setup((void*)0,102,0,0,-1,G__defined_typename("Float_t"),-1,4,"denom=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__DihBsaDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncDIS(void) {
   ...
   G__memfunc_setup("DIS",224,G__DihBsaDict_630_0_1, 105, G__get_linked_tagnum(&G__DihBsaDictLN_DIS), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetBeamEn",852,G__DihBsaDict_630_0_2, 121, -1, -1, 0, 1, 1, 1, 0, "f - 'Float_t' 0 - newBeamEn", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetElectron",1128,G__DihBsaDict_630_0_3, 121, -1, -1, 0, 3, 1, 1, 0, 
"f - 'Float_t' 0 - px f - 'Float_t' 0 - py "
"f - 'Float_t' 0 - pz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Analyse",717,G__DihBsaDict_630_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__DihBsaDict_630_0_5, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BreitPrint",1027,G__DihBsaDict_630_0_6, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ComputeBreitKinematics",2267,G__DihBsaDict_630_0_7, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ResetVars",927,G__DihBsaDict_630_0_8, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__DihBsaDict_630_0_9, 85, G__get_linked_tagnum(&G__DihBsaDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&DIS::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__DihBsaDict_630_0_10, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&DIS::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__DihBsaDict_630_0_11, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&DIS::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__DihBsaDict_630_0_12, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&DIS::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__DihBsaDict_630_0_16, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__DihBsaDict_630_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&DIS::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__DihBsaDict_630_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&DIS::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__DihBsaDict_630_0_19, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&DIS::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__DihBsaDict_630_0_20, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&DIS::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("DIS", 224, G__DihBsaDict_630_0_21, (int) ('i'), G__get_linked_tagnum(&G__DihBsaDictLN_DIS), -1, 0, 1, 1, 1, 0, "u 'DIS' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~DIS", 350, G__DihBsaDict_630_0_22, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__DihBsaDict_630_0_23, (int) ('u'), G__get_linked_tagnum(&G__DihBsaDictLN_DIS), -1, 1, 1, 1, 1, 0, "u 'DIS' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
static void G__setup_memfuncTrajectory(void) {
   ...
   G__memfunc_setup("Trajectory",1063,G__DihBsaDict_631_0_1, 105, G__get_linked_tagnum(&G__DihBsaDictLN_Trajectory), -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - particle_index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetMomentum",1150,G__DihBsaDict_631_0_2, 121, -1, -1, 0, 3, 1, 1, 0, 
"f - 'Float_t' 0 - px f - 'Float_t' 0 - py "
"f - 'Float_t' 0 - pz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Name",385,G__DihBsaDict_631_0_3, 117, G__get_linked_tagnum(&G__DihBsaDictLN_TString), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Title",514,G__DihBsaDict_631_0_4, 117, G__get_linked_tagnum(&G__DihBsaDictLN_TString), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PID",221,G__DihBsaDict_631_0_5, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Mass",404,G__DihBsaDict_631_0_6, 102, -1, G__defined_typename("Float_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__DihBsaDict_631_0_7, 85, G__get_linked_tagnum(&G__DihBsaDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&Trajectory::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__DihBsaDict_631_0_8, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Trajectory::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__DihBsaDict_631_0_9, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&Trajectory::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__DihBsaDict_631_0_10, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&Trajectory::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__DihBsaDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__DihBsaDict_631_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__DihBsaDict_631_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Trajectory::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__DihBsaDict_631_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Trajectory::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__DihBsaDict_631_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Trajectory::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__DihBsaDict_631_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Trajectory::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("Trajectory", 1063, G__DihBsaDict_631_0_19, (int) ('i'), G__get_linked_tagnum(&G__DihBsaDictLN_Trajectory), -1, 0, 1, 1, 1, 0, "u 'Trajectory' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Trajectory", 1189, G__DihBsaDict_631_0_20, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__DihBsaDict_631_0_21, (int) ('u'), G__get_linked_tagnum(&G__DihBsaDictLN_Trajectory), -1, 1, 1, 1, 1, 0, "u 'Trajectory' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncDihadron(void) {
   ...
   G__memfunc_setup("Dihadron",809,G__DihBsaDict_632_0_1, 105, G__get_linked_tagnum(&G__DihBsaDictLN_Dihadron), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetEvent",814,G__DihBsaDict_632_0_2, 121, -1, -1, 0, 3, 1, 1, 0, 
"U 'Trajectory' - 0 - trajPlus U 'Trajectory' - 0 - trajMinus "
"U 'DIS' - 0 - disEv", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ComputeAngles",1335,G__DihBsaDict_632_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PlaneAngle",983,G__DihBsaDict_632_0_4, 102, -1, G__defined_typename("Float_t"), 0, 4, 1, 1, 0, 
"u 'TVector3' - 0 - vA u 'TVector3' - 0 - vB "
"u 'TVector3' - 0 - vC u 'TVector3' - 0 - vD", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Reject",605,G__DihBsaDict_632_0_5, 117, G__get_linked_tagnum(&G__DihBsaDictLN_TVector3), -1, 0, 2, 1, 1, 0, 
"u 'TVector3' - 0 - vA u 'TVector3' - 0 - vB", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Project",727,G__DihBsaDict_632_0_6, 117, G__get_linked_tagnum(&G__DihBsaDictLN_TVector3), -1, 0, 2, 1, 1, 0, 
"u 'TVector3' - 0 - vA u 'TVector3' - 0 - vB", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__DihBsaDict_632_0_7, 85, G__get_linked_tagnum(&G__DihBsaDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&Dihadron::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__DihBsaDict_632_0_8, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Dihadron::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__DihBsaDict_632_0_9, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&Dihadron::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__DihBsaDict_632_0_10, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&Dihadron::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__DihBsaDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__DihBsaDict_632_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__DihBsaDict_632_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Dihadron::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__DihBsaDict_632_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Dihadron::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__DihBsaDict_632_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Dihadron::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__DihBsaDict_632_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Dihadron::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("Dihadron", 809, G__DihBsaDict_632_0_19, (int) ('i'), G__get_linked_tagnum(&G__DihBsaDictLN_Dihadron), -1, 0, 1, 1, 1, 0, "u 'Dihadron' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Dihadron", 935, G__DihBsaDict_632_0_20, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__DihBsaDict_632_0_21, (int) ('u'), G__get_linked_tagnum(&G__DihBsaDictLN_Dihadron), -1, 1, 1, 1, 1, 0, "u 'Dihadron' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
